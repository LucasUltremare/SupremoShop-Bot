...
client.once('ready', async () => {
  ...
  client.on("guildMemberAdd", async (member) => {
    ...
    let guild = client.guilds.cache.get("971606199181127731");
    let channel = client.channels.cache.get("");
    const cargo = member.guild.roles.cache.get("1025232553873002556")
...
msg.channel.bulkDelete(50);
                                        ...
                                        var payment_data = {
                                            ...
                                            payer: {
                                                email: 'lucas.ultremare@gmail.com',
                                                first_name: 'Lucas',
                                                last_name: 'Ultremare',
                                                identification: {
                                                    type: 'CPF',
